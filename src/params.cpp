...
long modifiable_interval_between_wave_spectra_measurements {interval_between_wave_spectra_measurements};
long modifiable_interval_between_gnss_measurements_seconds {interval_between_gnss_measurements_seconds};
size_t modifiable_min_nbr_of_fix_per_message {min_nbr_of_fix_per_message};
